...
func Prepare(ctx context.Context, db DBTX) (*Queries, error) {
	...
	if q.getCategoriesWithCountByParentIDStmt, err = db.PrepareContext(ctx, getCategoriesWithCountByParentID); err != nil {
		return nil, fmt.Errorf("error preparing query GetCategoriesWithCountByParentID: %w", err)
	}
	...
	if q.getParentCategoriesWithCountStmt, err = db.PrepareContext(ctx, getParentCategoriesWithCount); err != nil {
		return nil, fmt.Errorf("error preparing query GetParentCategoriesWithCount: %w", err)
	}
...
func (q *Queries) Close() error {
	...
	if q.getCategoriesWithCountByParentIDStmt != nil {
		if cerr := q.getCategoriesWithCountByParentIDStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getCategoriesWithCountByParentIDStmt: %w", cerr)
		}
	}
	...
	if q.getParentCategoriesWithCountStmt != nil {
		if cerr := q.getParentCategoriesWithCountStmt.Close(); cerr != nil {
			err = fmt.Errorf("error closing getParentCategoriesWithCountStmt: %w", cerr)
		}
	}
...
type Queries struct {
	...
	getCategoriesWithCountByParentIDStmt *sql.Stmt
	getCategoryByIDStmt                  *sql.Stmt
	getParentCategoriesWithCountStmt     *sql.Stmt
...
func (q *Queries) WithTx(tx *sql.Tx) *Queries {
	return &Queries{
		...
		getCategoriesWithCountByParentIDStmt: q.getCategoriesWithCountByParentIDStmt,
		getCategoryByIDStmt:                  q.getCategoryByIDStmt,
		getParentCategoriesWithCountStmt:     q.getParentCategoriesWithCountStmt,
